...
public class HourNode {
    ...
    public SubjectPlaceHolder placeHolder;
    ArrayList<HourNode> sameTimeConnection;
    ArrayList<HourNode> specialConnection;
    public ArrayList<SubjectPlaceHolder> domain;
    DayNode sameDayConnection, nextDayConnection, prevDayConnection;
    public HourNode nextHour, prevHour;
    public ClassNode nextClass, prevClass, sameClass;

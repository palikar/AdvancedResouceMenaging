...
import advancedresoucemenaging.GUIClasses.ConditionUI;
...
public class ConditionDescription {
    ...
    public ArrayList<SubjectPlaceHolder> subs;
    public int[][] daysEnebled;
    private JPanel UI;
    public String clas;
    ...
    private Collection<? extends Component> getAllComponents(Container container) {

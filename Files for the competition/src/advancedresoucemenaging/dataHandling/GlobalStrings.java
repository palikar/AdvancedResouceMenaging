...
public class GlobalStrings {
    ...
    public static final String saveToolTipString = "Запазване на информацията в настоящия файл.";
    public static final String saveAsToolTipString = "Запазване на информацията в нов файл.";
    public static final String loadToolTipString = "Зареждане на информация от файл.";
    public static final String exitTootllTipString = "Изход от програмата.";
    public static final String shuffleToolTipString = "Случайно разбъркване на предметите при генериране на разписание.";
    public static final String shuffleString = "Разбъркване";
    public static final String settingsString = "Настройки";
}

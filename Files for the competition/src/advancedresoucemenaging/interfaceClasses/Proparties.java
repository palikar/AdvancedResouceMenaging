...
public class Proparties extends GradientPanel implements ListSelectionListener, ActionListener {
    ...
    void refreshPorparties() {
        ...
        for (ConditionDescription c : GlobalSpace.classController.conditions.get(GlobalSpace.classController.classes.get(classes.getSelectedIndex()))) {
            propartiesModel.addElement(ConditionCodeList.getName(c.code));
        }
    }
    ...
    public void valueChanged(ListSelectionEvent e) {
        if (e.getSource().equals(classes)) {
            propartiesModel.clear();
            if (classes.getSelectedIndex() != -1) {
                for (ConditionDescription desc : GlobalSpace.classController.conditions.get(classes.getSelectedValue().toString())) {
                    propartiesModel.addElement(ConditionCodeList.getName(desc.code));
                }
            }
            ...
            if (classes.getSelectedIndex() == -1 || proparties.getSelectedIndex() == -1) {
                ...
                currentDesc = GlobalSpace.classController.conditions.get(classes.getSelectedValue().toString()).get(proparties.getSelectedIndex());
            }
            refreshConditionUI();
        }
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(add)) {
            ...
            Object input[] = {new JLabel(GlobalStrings.typeString), type};
            if (classes.getSelectedIndex() == -1) {
            ...
            newDesc.code = type.getSelectedIndex() + 1;
            GlobalSpace.classController.conditions.get(classes.getSelectedValue().toString()).add(newDesc);
            propartiesModel.addElement(ConditionCodeList.getName(newDesc.code));
            ...
            GlobalSpace.classController.conditions.get(GlobalSpace.classController.classes.get(classes.getSelectedIndex())).remove(proparties.getSelectedIndex());
            refreshPorparties();
        }
    }
}

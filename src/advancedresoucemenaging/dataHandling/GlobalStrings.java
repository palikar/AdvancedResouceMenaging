...
public class GlobalStrings
{
    ...
    public static String classesString = "Класове:";
    ...
    public static String exit = "Изход";
    public static String loadString = "Зареди";
    public static String schoolString = "Училище: ";
    public static String principleString = "Директор: ";
    public static String opendString = "Отворен";
    public static String addString = "Добави";
    public static String removeString = "Премахни";
    public static String newClassString = "Нов клас";
    public static String newTeacherString = "Нов учител";
    public static String newSubjectString = "Нов предмет";
    ...
    public static String classString = "Клас:";
    public static String printString = "Принтирай";
    ...
    public static String mondayString = "Понеделник";
    public static String tuesdaySting = "Вторник";
    public static String wendsdaySting = "Сряда";
    public static String thusdayString = "Четвъртък";
    public static String fridayString = "Петък";
    public static String hourSting = "Час";
    public static String saveToolTipString = "Запазване на информацията в настоящия файл.";
    public static String saveAsToolTipString = "Запазване на информацията в нов файл.";
    public static String loadToolTipString = "Зареждане на информация от файл.";
    public static String exitTootllTipString = "Изход от програмата.";
    public static String shuffleToolTipString = "Случайно разбъркване на предметите при генериране на разписание.";
    public static String shuffleString = "Разбъркване";
    public static String settingsString = "Настройки";
    public static String invalidSynaxString = "Невалиден формат";
    public static String paramsString = "Други параметри";
    public static String valueString = "Стойност:";
